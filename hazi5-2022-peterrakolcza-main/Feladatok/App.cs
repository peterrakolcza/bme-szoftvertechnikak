...
namespace Signals
{
    ...
    public class App
    {
        ...
        /// A főablakot tárolja.
        /// </summary>
        private MainForm_IMO7KC mainForm;
        /// <summary>
        ...
        /// </summary>
        public static void Initialize(MainForm_IMO7KC form)
        {
            theApp = new App();
        ...
        /// A főablak.
        /// </summary>
        public MainForm_IMO7KC MainForm
        {
            get { return mainForm; }
        }
        ...
        public void OpenDocument()
        {
            ...
            SignalDocument doc = new SignalDocument(Path.GetFileName(openFileDialog.FileName));
            documents.Add(doc);
            createView(doc, true);
            ...
            doc.LoadDocument(openFileDialog.FileName);
